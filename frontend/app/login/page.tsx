...
<main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-950 via-blue-900 to-slate-900 p-4 font-sans">
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center h-20 w-20 rounded-2xl bg-gradient-to-br from-blue-400 via-blue-500 to-emerald-400 shadow-2xl mb-4">
            <i className="fas fa-warehouse text-4xl text-white"></i>
          </div>
          <h1 className="text-4xl font-extrablack tracking-tight text-white drop-shadow-lg">
            CARGO
          </h1>
